module GameData
  class TerrainTag # The main part only, not the crest
    attr_reader :id, :id_number, :real_name, :can_surf, :waterfall, :waterfall_crest, :can_fish, :can_dive, :deep_bush,
                :shows_grass_rustle, :shows_water_ripple, :land_wild_encounters, :double_wild_encounters, :battle_environment, :ledge, :ice, :bridge, :shows_reflections, :must_walk, :must_walk_or_run, :ignore_passability
    ...
    def self.try_get(other)
      return get(:None) if other.nil?

      validate other => [Symbol, self, String, Integer]
      return other if other.is_a?(self)

      other = other.to_sym if other.is_a?(String)
      self::DATA.has_key?(other) ? self::DATA[other] : get(:None)
    end
    ...
    def can_surf_freely
      @can_surf && !@waterfall && !@waterfall_crest
    end
  end
end
