...
class Battle::AI
  ...
  def pokemon_airborne?(pkmn)
    ...
    return true if pkmn.hasAbility?(%i[LEVITATE ORNITHES])
  ...
  BASE_ABILITY_RATINGS = {
    10 => %i[DELTASTREAM DESOLATELAND HUGEPOWER MOODY PARENTALBOND
             POWERCONSTRUCT PRIMORDIALSEA PUREPOWER SHADOWTAG
             STANCECHANGE WONDERGUARD FORECAST],
    9 => %i[ARENATRAP DRIZZLE DROUGHT IMPOSTER MAGICBOUNCE MAGICGUARD
            MAGNETPULL SANDSTREAM SPEEDBOOST ORNITHES],
    8 => %i[ADAPTABILITY AERILATE CONTRARY DISGUISE DRAGONSMAW
            ...
            SIMPLE SNOWWARNING TECHNICIAN TRANSISTOR WATERBUBBLE TWISTEDDIM SEAGUARDIAN],
    7 => %i[BEASTBOOST BULLETPROOF COMPOUNDEYES DOWNLOAD FURCOAT
            HUSTLE ICESCALES INTIMIDATE ESPANTO LEVITATE LIGHTNINGROD
    ...
    6 => %i[BATTLEBOND CHLOROPHYLL COMATOSE DARKAURA DRYSKIN
            FAIRYAURA AURADORADA FILTER FLASHFIRE GALEWINGS GUTS
    ...
    5 => %i[AFTERMATH AIRLOCK ANALYTIC BERSERK BLAZE CLOUDNINE
    ...
    4 => %i[ANGERPOINT BADDREAMS CHEEKPOUCH CLEARBODY CURSEDBODY
    ...
    3 => %i[AROMAVEIL AURABREAK COTTONDOWN DAUNTLESSSHIELD
    ...
    2 => %i[BATTLEARMOR COLORCHANGE CUTECHARM DAMP GRASSPELT
    ...
    1 => %i[BIGPECKS KEENEYE MAGMAARMOR PICKUP RIVALRY STENCH],
    0 => %i[ANTICIPATION ASONECHILLINGNEIGH ASONEGRIMNEIGH BALLFETCH
    ...
    -1 => %i[DEFEATIST HEAVYMETAL KLUTZ NORMALIZE PERISHBODY STALL
             ZENMODE],
    -2 => %i[SLOWSTART TRUANT]
  }
  ...
  BASE_ITEM_RATINGS = {
    ...
    8 => %i[LEEK STICK THROATSPRAY WEAKNESSPOLICY],
    7 => %i[EXPERTBELT LIGHTBALL LUMBERRY POWERHERB ROCKYHELMET
            SITRUSBERRY],
    ...
    4 => %i[ADRENALINEORB APICOTBERRY BLUNDERPOLICY CHESTOBERRY
    ...
    0 => [:SMOKEBALL],
    -5 => %i[FULLINCENSE LAGGINGTAIL RINGTARGET],
    -6 => %i[MACHOBRACE POWERANKLET POWERBAND POWERBELT POWERBRACER
             POWERLENS POWERWEIGHT],
    -7 => %i[FLAMEORB IRONBALL TOXICORB],
    -9 => [:STICKYBARB]
  }
end
...
Battle::AI::Handlers::ItemRanking.add(:AGUAVBERRY,
                                      proc { |item, score, battler, ai|
                                        ...
                                        if ai.trainer.high_skill? && battler.battler.nature.stat_changes.any? do |val|
                                          val[0] == :SPECIAL_DEFENSE && val[1] < 0
                                        end
...
Battle::AI::Handlers::ItemRanking.add(:ASSAULTVEST,
                                      proc { |item, score, battler, ai|
                                        if ai.trainer.high_skill? && !battler.check_for_move do |m|
                                          m.statusMove? && !m.is_a?(Battle::Move::UseMoveTargetIsAboutToUse)
                                        end
                                          score += 1
                                        end
                                        next score
...
Battle::AI::Handlers::ItemRanking.add(:SOULDEW,
                                      proc { |item, score, battler, ai|
                                        ...
                                        if Settings::SOUL_DEW_POWERS_UP_TYPES
                                          next 0 unless battler.has_damaging_move_of_type?(:PSYCHIC, :DRAGON)
...
Battle::AI::Handlers::ItemRanking.addIf(:type_boosting_items,
                                        ...
                                        proc { |item, score, battler, ai|
                                          boosters = {
                                            BUG: %i[SILVERPOWDER INSECTPLATE],
                                            ...
                                            GHOST: %i[SPELLTAG SPOOKYPLATE],
                                            GRASS: %i[MIRACLESEED MEADOWPLATE ROSEINCENSE],
                                            GROUND: %i[SOFTSAND EARTHPLATE],
                                            ICE: %i[NEVERMELTICE ICICLEPLATE],
                                            NORMAL: [:SILKSCARF],
                                            POISON: %i[POISONBARB TOXICPLATE],
                                            PSYCHIC: %i[TWISTEDSPOON MINDPLATE ODDINCENSE],
                                            ROCK: %i[HARDSTONE STONEPLATE ROCKINCENSE],
                                            STEEL: %i[METALCOAT IRONPLATE],
                                            WATER: %i[MYSTICWATER SPLASHPLATE SEAINCENSE WAVEINCENSE]
                                          }
                                          boosted_type = nil
...
Battle::AI::Handlers::ItemRanking.addIf(:gems,
                                        proc { |item|
                                          next %i[FIREGEM WATERGEM ELECTRICGEM GRASSGEM ICEGEM FIGHTINGGEM
