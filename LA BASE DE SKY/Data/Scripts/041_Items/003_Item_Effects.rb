...
unless Settings::RAGE_CANDY_BAR_CURES_STATUS_PROBLEMS
...
ItemHandlers::UsableOnPokemon.add(:GRACIDEA, proc { |item, pkmn|
  next pkmn.isSpecies?(:SHAYMIN) && pkmn.able? && pkmn.form == 0 && !%i[FROZEN FROSTBITE].include?(pkmn.status) && !PBDayNight.isNight?
})
