if Settings::SHOW_ITEM_DESCRIPTIONS_ON_RECEIVE
  ...
  class PokemonItemFind_Scene
    ...
    def pbStartScene(item)
      ...
      @sprites['descwindow'] =
        Window_UnformattedTextPokemon.newWithSize('', DESC_WINDOW_X, DESC_WINDOW_Y, Graphics.width + DESC_WINDOW_WIDTH_OFFSET,
                                                  DESC_WINDOW_HEIGHT, @viewport)
      ...
      @sprites['titlewindow'] =
        Window_UnformattedTextPokemon.newWithSize('', TITLE_WINDOW_X, TITLE_WINDOW_Y, TITLE_WINDOW_WIDTH, TITLE_WINDOW_HEIGHT,
                                                  @viewport)
  ...
  class ItemLog
    ...
    def register(item)
      return if @found_items.include?(item)
