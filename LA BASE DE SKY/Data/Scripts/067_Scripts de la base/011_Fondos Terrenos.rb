...
class Battle::Scene
  ...
  def pbDeleteTrickRoomBackground
    return unless @sprites['trick_room_bg']&.visible
  ...
  def pbDeleteHazardSprites
    ...
    %w[stealthrock_0 stealthrock_1 stickyweb_0 stickyweb_1].each do |sprite_id|
      next unless @sprites[sprite_id]
  ...
  def pbUpdateHazardSprites
    ...
    2.times do |side|
      ...
      toxic_count.times do |layer|
        ...
        offset_y = [[-20, -20], [-20, -20]][side][layer] # Keep near the base level
      ...
      next unless sideData.effects[PBEffects::StickyWeb]
