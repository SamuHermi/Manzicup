...
module Settings
  ...
  LOCATION_SIGN_GRAPHIC_STYLES = {
    ...
    hgss: [{ graphic: 'HGSS cave',    text_color: Color.new(232, 232, 232), shadow_color: Color.new(120, 144, 160), center_text: true },
           { graphic: 'HGSS city',    text_color: Color.new(56, 64, 72),
             shadow_color: Color.new(152, 152, 144), center_text: true },
           { graphic: 'HGSS default', text_color: Color.new(48, 64, 72),
             shadow_color: Color.new(144, 144, 96),  center_text: true },
           { graphic: 'HGSS forest',  text_color: Color.new(232, 232, 232),
             shadow_color: Color.new(120, 176, 144), center_text: true },
           { graphic: 'HGSS lake',    text_color: Color.new(40, 48, 56),
             shadow_color: Color.new(104, 144, 192), center_text: true },
           { graphic: 'HGSS park',    text_color: Color.new(40, 48, 56),
             shadow_color: Color.new(120, 136, 152), center_text: true },
           { graphic: 'HGSS route',   text_color: Color.new(48, 64, 72),
             shadow_color: Color.new(136, 136, 104), center_text: true },
           { graphic: 'HGSS sea',     text_color: Color.new(216, 240, 248),
             shadow_color: Color.new(24, 96, 144),   center_text: true },
           { graphic: 'HGSS town',    text_color: Color.new(48, 56, 64),
             shadow_color: Color.new(144, 120, 80),  center_text: true }],
