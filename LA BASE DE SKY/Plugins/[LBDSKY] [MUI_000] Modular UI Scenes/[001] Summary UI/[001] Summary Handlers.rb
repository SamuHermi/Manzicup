...
UIHandlers.add(:summary, :page_info, {
                 ...
                 'suffix' => _INTL('info'),
                 'order' => 10,
                 'options' => [:item] + (Settings::ALLOW_RENAMING_POKEMON_IN_SUMMARY_SCREEN ? [:nickname] : []) + %i[pokedex mark
                                                                                                                     legacy],
...
UIHandlers.add(:summary, :page_moves, {
                 ...
                 'suffix' => _INTL('moves'),
                 'order' => 40,
                 'options' => [:moves] + (if Settings::ALLOW_CHANGING_MOVES_IN_SUMMARY_SCREEN
                                            %i[remember
                                               forget]
                                          else
                                            []
