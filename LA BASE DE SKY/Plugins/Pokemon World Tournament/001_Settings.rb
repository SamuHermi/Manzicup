...
GameData::PWTTournament.register({
  ...
  :name => _INTL("Manzidadas"),		# Display name of the Tournament in the choice selection box
  :trainers => [						
                [:PABLO,"Pablo","","",10,"","",""],
                [:SABO,"Sabo","","",10,"","",""], 
                [:ANA,"Ana","","",10,"","",""],
...
GameData::PWTTournament.register({
  :id => :Manzidadas_facil,			# Internal name of the Tournament to be called
  :name => _INTL("Manzidadas"),		# Display name of the Tournament in the choice selection box
  :trainers => [						
                [:PABLO,"Pablo","","",0,"","",""],
                [:SABO,"Sabo","","",0,"","",""], 
