...
module RandomizedChallenge
  ...
  MOVEBLACKLIST = %i[CHATTER DIG TELEPORT SONICBOOM DRAGONRAGE STRUGGLE]

  # Lista de posibles Pokémon que aparecerán como Pokémon Iniciales.
  ListaStartersRandomizado = %i[
  ...
  TIPO_DE_RANDOM_DE_HABILIDADES = nil
  ...
  BLACK_LIST = %i[EGGHATCHER EMPTYVIAL VIAL METEORITE MEGARING
                  EXPCHARM CATCHINGCHARM SHINYCHARM OVALCHARM REINSOFUNITYUSED NSOLARIZERUSED
                  NLUNARIZERUSED DNASPLICERSUSED ZYGARDECUBE
