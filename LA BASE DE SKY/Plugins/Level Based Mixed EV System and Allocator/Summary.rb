...
class EVAllocationSprite2 < Sprite
  ...
  def initialize(viewport = nil, fifthmove = false)
    super(viewport)
    @EVsel2 = if PluginManager.installed?('BW Summary Screen')
                AnimatedBitmap.new('Graphics/Plugins/Level Based Mixed EV System and Allocator/EVsel2BW')
              elsif PluginManager.installed?('EVs and IVs in Summary v20')
                AnimatedBitmap.new('Graphics/Plugins/Level Based Mixed EV System and Allocator/EVsel2evsivs')
              else
                AnimatedBitmap.new('Graphics/Plugins/Level Based Mixed EV System and Allocator/EVsel2')
              end
    @frame = 0
    @index = 0
    @fifthmove = fifthmove
...
class PokemonSummary_Scene
  ...
  if PluginManager.installed?('BW Summary Screen')
    ...
    def drawPageThree
      ...
      pbDisplayIVRatings(@pokemon, overlay, 110, 82) if SHOW_IV_RATINGS && PluginManager.installed?('Enhanced UI')
      if SHOW_EV_IV
        textpos.push(
          [format('%d', @pokemon.iv[:HP]), 296, 82, 2, base, shadow],
          [format('%d', @pokemon.iv[:ATTACK]), 296, 132, 2, base, shadow],
          [format('%d', @pokemon.iv[:DEFENSE]), 296, 164, 2, base, shadow],
          [format('%d', @pokemon.iv[:SPECIAL_ATTACK]), 296, 196, 2, base, shadow],
          [format('%d', @pokemon.iv[:SPECIAL_DEFENSE]), 296, 228, 2, base, shadow],
          [format('%d', @pokemon.iv[:SPEED]), 296, 260, 2, base, shadow]
        )
      end
    ...
    def drawPageThree
      ...
      textpos = [
        ...
        [format('%d/%d', @pokemon.hp, @pokemon.totalhp), 382, 83, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:HP]), 444, 83, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[:HP]), 496, 83, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Attack'), 225, 127, 0, base, statshadows[:ATTACK]],
        [format('%d', @pokemon.attack), 382, 127, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:ATTACK]), 444, 127, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[:ATTACK]), 496, 127, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Defense'), 225, 159, 0, base, statshadows[:DEFENSE]],
        [format('%d', @pokemon.defense), 382, 159, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:DEFENSE]), 444, 159, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[:DEFENSE]), 496, 159, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Sp. Atk'), 225, 191, 0, base, statshadows[:SPECIAL_ATTACK]],
        [format('%d', @pokemon.spatk), 382, 191, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:SPECIAL_ATTACK]), 444, 191, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[spatk]), 496, 191, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)], # DemICE edit
        [_INTL('Sp. Def'), 225, 223, 0, base, statshadows[:SPECIAL_DEFENSE]],
        [format('%d', @pokemon.spdef), 382, 223, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:SPECIAL_DEFENSE]), 444, 223, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[:SPECIAL_DEFENSE]), 496, 223, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Speed'), 225, 255, 0, base, statshadows[:SPEED]],
        [format('%d', @pokemon.speed), 382, 255, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.iv[:SPEED]), 444, 255, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [format('%d', @pokemon.ev[:SPEED]), 496, 255, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)] # ,
  ...
  elsif Settings::I_EDITED_MY_SUMMARY
    ...
    def drawPageThree
      ...
      textpos = [
        ...
        [format('%d/%d', @pokemon.hp, @pokemon.totalhp), 462, 82, 1, Color.new(64, 64, 64),
         Color.new(176, 176, 176)],
        [_INTL('Attack'), 244, 126, 0, base, statshadows[:ATTACK]],
        [format('%d', @pokemon.attack), 456, 126, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Defense'), 244, 158, 0, base, statshadows[:DEFENSE]],
        [format('%d', @pokemon.defense), 456, 158, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Sp. Atk'), 244, 190, 0, base, statshadows[:SPECIAL_ATTACK]],
        [format('%d', @pokemon.spatk), 456, 190, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Sp. Def'), 244, 222, 0, base, statshadows[:SPECIAL_DEFENSE]],
        [format('%d', @pokemon.spdef), 456, 222, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)],
        [_INTL('Speed'), 244, 254, 0, base, statshadows[:SPEED]],
        [format('%d', @pokemon.speed), 456, 254, 1, Color.new(64, 64, 64), Color.new(176, 176, 176)] # , #DemICE edit
        # [_INTL("Ability"), 224, 290, 0, base, shadow]  #DemICE edit
      ]
      ...
      if PluginManager.installed?('Enhanced UI') && Settings::SUMMARY_IV_RATINGS
        overlay = @sprites['overlay'].bitmap
        pbDisplayIVRating(@pokemon, overlay, 465, 82)
      end
      return unless PluginManager.installed?('ZUD Mechanics')
      return unless @pokemon.dynamax_able? && !@pokemon.isSpecies?(:ETERNATUS) && !$game_switches[Settings::NO_DYNAMAX]
