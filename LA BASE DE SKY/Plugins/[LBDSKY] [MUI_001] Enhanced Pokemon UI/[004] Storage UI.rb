  ...
  def pbUpdateOverlay(selection, party = nil)
    ...
    pbDrawTextPositions(
      ...
      [[_INTL('Equipo: {1}', begin
        ...
        0
      end), TEAM_TEXT_X, TEAM_TEXT_Y, :center, buttonbase, buttonshadow, :outline],
    ...
    unless pokemon.egg?
      imagepos = []
      if pokemon.male?
        textstrings.push([_INTL('♂'), GENDER_ICON_TEXT_X, GENDER_ICON_TEXT_Y, :left, Color.new(24, 112, 216),
                          Color.new(136, 168, 208)])
      elsif pokemon.female?
        textstrings.push([_INTL('♀'), GENDER_ICON_TEXT_X, GENDER_ICON_TEXT_Y, :left, Color.new(248, 56, 32),
      ...
      pbDrawImagePositions(plugin_overlay, [['Graphics/UI/shiny', SHINY_ICON_X, SHINY_ICON_Y]]) if pokemon.shiny?
