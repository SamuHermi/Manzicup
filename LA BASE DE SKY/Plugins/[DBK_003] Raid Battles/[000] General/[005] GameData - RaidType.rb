...
GameData::RaidType.register({
  :id             => :Basic,
  :name           => "Basic",
  :den_name       => _INTL("Nido de incursión"),
  :den_sprite     => "Object den (Basic)",
  :den_size       => 3,
  :lair_name      => _INTL("Aventura básica"),
  :lair_bgm       => "Raid (Basic) adventure",
  :battle_text    => _INTL("¡{1} emergío de dentro del nido!"),
  :battle_flee    => _INTL("{1} se adentró en el nido..."),
...
GameData::RaidType.register({
  :id             => :Ultra,
  :name           => "Ultra",
  :den_name       => _INTL("Incursión de ultraumbral"),
  :den_sprite     => "Object den (Ultra)",
  :den_size       => 3,
  :lair_name      => _INTL("Ultra aventura"),
  :lair_bgm       => "Raid (Ultra) adventure",
  :battle_bg      => "raid_ultra",
  :battle_base    => "raid_ultra",
  :battle_environ => :UltraSpace,
  :battle_text    => _INTL("¡{1} salió del umbral!"),
  :battle_flee    => _INTL("{1} dse desvaneció a través del umbral..."),
...
GameData::RaidType.register({
  :id             => :Max,
  :name        	  => "Max",
  :den_name    	  => _INTL("Nido dinamax"),
  :den_sprite     => "Object den (Max)",
  :den_size       => 2,
  :lair_name      => _INTL("Aventura dinamax"),
  :lair_bgm       => "Raid (Max) adventure",
  :battle_bg      => "raid_max",
  :battle_base    => "raid_max",
  :battle_text    => _INTL("¡Un {1} dinamax emergió de dentro del nido!"),
  :battle_flee    => _INTL("{1} se adentró en el nido..."),
...
GameData::RaidType.register({
  :id             => :Tera,
  :name           => "Tera",
  :den_name       => _INTL("Teraincursión"),
  :den_sprite     => "Object den (Tera)",
  :den_size       => 2,
  :lair_name      => _INTL("Teraventura"),
  :lair_bgm       => "Raid (Tera) adventure",
  :battle_bg      => "raid_tera",
  :battle_base    => "raid_tera",
  :battle_text    => _INTL("¡Un {1} terastalizado emergió de dentro del nido!"),
  :battle_flee    => _INTL("{1} se adentró en el nido..."),
