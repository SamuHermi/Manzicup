...
class PokemonPauseMenu_Scene
  ...
  def pbStartScene
    ...
    @selRoute = "Graphics/Pictures/PauseMenu/sel"
    case $player.character_ID
    when 1
      @selRoute = "Graphics/Pictures/PauseMenu/sel_hermi"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_hermi"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 2
      @selRoute = "Graphics/Pictures/PauseMenu/sel_iria"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_iria"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 3
      @selRoute = "Graphics/Pictures/PauseMenu/sel_jess"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_jess"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 4
      @selRoute = "Graphics/Pictures/PauseMenu/sel_brais"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_brais"),Rect.new(0, 0, Graphics.width, Graphics.height))  
    when 5
      @selRoute = "Graphics/Pictures/PauseMenu/sel_isa"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_isa"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 6
      @selRoute = "Graphics/Pictures/PauseMenu/sel_samer"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_samer"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 7
      @selRoute = "Graphics/Pictures/PauseMenu/sel_rodri"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_rodri"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 8
      @selRoute = "Graphics/Pictures/PauseMenu/sel_bra"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_bra"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 9
      @selRoute = "Graphics/Pictures/PauseMenu/sel_ana"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_ana"),Rect.new(0, 0, Graphics.width, Graphics.height))
    when 10
      @selRoute = "Graphics/Pictures/PauseMenu/sel_pablo"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_pablo"),Rect.new(0, 0, Graphics.width, Graphics.height))    
    when 11
      @selRoute = "Graphics/Pictures/PauseMenu/sel_sabo"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_sabo"),Rect.new(0, 0, Graphics.width, Graphics.height))   
    when 12
      @selRoute = "Graphics/Pictures/PauseMenu/sel_nerea"
      @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/Pictures/PauseMenu/bg_nerea"),Rect.new(0, 0, Graphics.width, Graphics.height)) 
    else
    ...
    content = []
    text = []
    content.push(_INTL("Manzicoins: {1}",$player.battle_points))
    if pbInSafari?
      ...
      if pbBugContestState.lastPokemon
        content.push(_INTL("Capturas: {1}", pbBugContestState.lastPokemon.speciesName))
