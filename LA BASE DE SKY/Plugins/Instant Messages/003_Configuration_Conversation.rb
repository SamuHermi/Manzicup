...
GameData::InstantMessageConversation.register({
    ...
    :important      => true,
    :messages       => [
                        [5,  :Text, _INTL("Quien queda hoy?")],
                        [1,  :Text, _INTL("Por mi guay.")],
                        [3,  :Text, _INTL("Oki")],
                        [6,  :Text, _INTL("Nerea y yo vamos pero más tarde")],
                        [8,  :Text, _INTL("Va, venga")],
                        [7,  :Text, _INTL("Pa y yo también, chiquillos")],
                        [9,  :Text, _INTL("Sorprendentemente, hoy no trabajo")],
                        [10, :Text, _INTL("Ostia, ¿Cuadramos todos? ¿Se han alineado los astros o qué? ¿Ni billar, ni trabajo, ni nada?")],
                        [2,  :Text, _INTL("No mi loco, que estamos en descanso")],
                        [4, :Text, _INTL("¿Entonces quedamos a las 6?")],
                        [11,  :Text, _INTL("¿En donde?")],
                        [1,  :Text, _INTL("En el pósito, supongo")],
                        [5,  :Text, _INTL("Por mi bien")],                   
                        [3,  :Text, _INTL("Sí, como siempre")],
                        [2, :Picture, "Pollo"],
                        [10, :Picture, "Pollo"],
                        [1, :Picture, "Pollo"],
                        ]
...
GameData::InstantMessageConversation.register({
    ...
    :important      => true,
    :messages       => [
                        [12,  :Text, _INTL("@everyone Eldar ha llegado. ✨")],
                        [12,  :Text, _INTL("Se ha metido en la sala de abajo, a la derecha. Si estáis por ahí, dadle la bienvenida (o preparaos para esconderos).")],
                        ...
                        [12,  :Text, _INTL("No os fiéis de mi modestia: igual no soy perfecta, ¡pero tengo buenas ideas para el drama! Solo os sugerí esconderos porque parecía la opción más divertida. ¿Queríais que os dijera “Hola Eldar, bienvenido, tomad asiento”?")],
