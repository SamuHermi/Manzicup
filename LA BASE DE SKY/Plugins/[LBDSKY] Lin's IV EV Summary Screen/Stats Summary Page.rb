...
class PokemonSummary_Scene
  def drawPageAllStats
    ...
    textpos = [
      ...
      [format('%d', @pokemon.iv[:HP]), 466, 131, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:HP]), 511, 131, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      ...
      [format('%d', @pokemon.iv[:ATTACK]), 466, 168, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:ATTACK]), 511, 168, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      ...
      [format('%d', @pokemon.iv[:DEFENSE]), 466, 205, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:DEFENSE]), 511, 205, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      ...
      [format('%d', @pokemon.iv[:SPECIAL_ATTACK]), 466, 242, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:SPECIAL_ATTACK]), 511, 242, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      ...
      [format('%d', @pokemon.iv[:SPECIAL_DEFENSE]), 466, 279, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:SPECIAL_DEFENSE]), 511, 279, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      ...
      [format('%d', @pokemon.iv[:SPEED]), 466, 316, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
      [format('%d', @pokemon.ev[:SPEED]), 511, 316, :left, Color.new(64, 64, 64), Color.new(176, 176, 176)],
