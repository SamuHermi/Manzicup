...
def pbMaxSocialLinkBond(profile_id,silent:true)
    ret = pbPlayerSocialLinksSaved.pbMaxLinkBond(profile_id, silent: silent)
end

alias pbMaxLinkBond pbMaxSocialLinkBond
...
class Window_Social_Menu < Window_DrawableCommand
    ...
    def drawItem(index, _count, rect)
        ...
        pbDrawImagePositions(self.contents, [[sprintf("Graphics/UI/Instant Messages/Characters/#{image}"), rect.x, rect.y + 6]])
        pbDrawImagePositions(self.contents, [[sprintf("Graphics/UI/Instant Messages/Characters/"), rect.x + rect.width - 36 - x_adj, rect.y + 22, img_x, 0, 26, 26]])
    end
