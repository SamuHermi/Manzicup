class AchievementButton < Sprite
  ...
  def refresh
    ...
    textpos=[          # Name is written on both unselected and selected buttons
       [@name,14,14,0,Color.new(248,248,248),Color.new(40,40,40)],
       [@name,14,66,0,Color.new(248,248,248),Color.new(40,40,40)],
       [@level,Settings::SCREEN_WIDTH-32,14,1,Color.new(248,248,248),Color.new(40,40,40)],
       [@level,Settings::SCREEN_WIDTH-32,66,1,Color.new(248,248,248),Color.new(40,40,40)]
    ]
...
class PokemonAchievements_Scene
  ...
  def pbStartScene
    ...
    @sprites["achievementText"]=AchievementText.new(8,Settings::SCREEN_HEIGHT-84,"Error.",_INTL("{1}/{2}","-1","-1"), @viewport)
